...
describe 'MilestonesController', type: :request do
  context 'show' do
    it 'should return milestone and all its steps if present' do
      ...
      get api_milestone_path(milestone)
  ...
  describe 'create' do
    context 'success' do
      it 'should return status created and goal' do
        ...
        post api_milestones_path(valid_milestone.as_json)
    ...
    context 'unauthorized' do
      it 'should return status unauthorized' do
        ...
        post api_milestones_path(invalid_milestone.as_json)
  ...
  describe 'delete' do
    it 'should return success message' do
      milestone = create(:milestone)
      delete api_milestone_path(milestone.id.as_json)
  ...
  describe 'update' do
    context 'success' do
      it 'should return ok message and updated milestone' do
        ...
        patch api_milestone_path(milestone.id, milestone_changes.as_json)
        p response.body
        expect(response).to have_http_status(200)
